...
_clanID = (_data select 43);
_clanName = (_data select 44);
...
_player setVariable ["ExileHumanity", (_data select 40)];
_player setVariable ["ExileKills", (_data select 41)];
_player setVariable ["ExileDeaths", (_data select 42)];
